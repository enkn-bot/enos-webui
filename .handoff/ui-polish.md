...
- New: src/lib/components/enos/{UserAvatar,EnosOrb,DeskWorkspacePicker}.svelte; src/lib/enos/{greeting,modelTier,trayOpen.test,deskUiSource.test,greeting.test,modelTier.test,uiCleanup.test}.ts; static/static/enos*loader_orb*\*.svg
